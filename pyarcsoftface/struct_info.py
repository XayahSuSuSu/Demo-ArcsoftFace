...
class ASF_MultiFaceInfo(Structure):
    ...
    def __str__(self):
        ...
        return "ASF_MultiFaceInfo(faceNum={},faceID={},faceOrient={},faceRect={})".format(self.faceNum, faceID,
                                                                                          faceOrient, faceRect)
...
class ASF_FaceFeature(Structure):
    ...
    def __str__(self):
        return ("ASF_FaceFeature(featureSize={} feature={})".format(self.featureSize,
                                                                    string_at(self.feature, self.featureSize)))
...
class ASF_GenderInfo(Structure):
    ...
    def __str__(self):
        if self.num:
            return "ASF_GenderInfo(num={},genderArray={})".format(self.num,
                                                                  [self.genderArray[i] for i in range(self.num)])
        else:
...
class ASF_LivenessThreshold(Structure):
    ...
    def __str__(self):
        return "ASF_LivenessThreshold(thresholdmodel_BGR={},thresholdmodel_IR={})".format(self.thresholdmodel_BGR,
                                                                                          self.thresholdmodel_IR)
